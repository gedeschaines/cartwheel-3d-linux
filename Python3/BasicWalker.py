...
app = App.SNMApp("Basic Walker", glCanvasSize = glCanvasSize, size = size, showConsole = showConsole)
...
print("Instantiate KeyframeEditor")
...
staircase = App.Scenario.Staircase( staircaseWidth = 0.9, threadDepth = 0.5, riserHeight = 0.05,
                                    stepCount = 4, position=(0.0,0.0,2.0), angle = 0.0,   
