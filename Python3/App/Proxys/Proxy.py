...
def _create( _wrappedClass, _members, _parent, _caster, _loader, _verbose, _icon, _nameGetter ):
    ...
    def fillObject(self, object, container = None):
        ...
        As a container, specify the object (not proxy object) to which this object is (or will be)
        attached with an HAS_A or HAS_MANY relationship.
    ...
    # Build a dictionary of members for efficient look-up
    _memberDict = {}
