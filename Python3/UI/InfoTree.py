...
class InfoTree(wx.Panel):
    ...
    def __init__(self, parent, object = None, rootName = "Root", autoVisible = False, onUpdate = None, id = wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        self._sashWindow = wx.adv.SashWindow( self )      
        self._sashWindow.SetSashVisible( wx.adv.SASH_TOP, True )
        ...
        self._sashWindow.Bind( wx.adv.EVT_SASH_DRAGGED, self.sashWindowResize )
    ...
    def selectionChanged(self, event):
        nodeData = self._infoTreeBasic.GetItemData(event.GetItem())
