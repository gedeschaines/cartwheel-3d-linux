...
class ToolSet(wx.Panel):
    ...
    def __init__(self, parent, id = wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        if resizable:
            ...
            self._sashWindow.SetSashVisible( wx.adv.SASH_BOTTOM, True )
            ...
            self._sashWindow.Bind( wx.adv.EVT_SASH_DRAGGED, self.toolSetResize )
        else:        
            # Setup the main tool set panel
    ...
    def addTool(self, widgetClass, proportion=0, flag=wx.EXPAND, border=0, desiredHeight = 0, **argkw ):
        ...
        minSize = self._panelVBox.GetMinSize().Get()
