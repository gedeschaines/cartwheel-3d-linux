...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent, id, title, pos=wx.DefaultPosition,
        ...
        attribList = (wx.glcanvas.WX_GL_DOUBLEBUFFER, 1,     # Double Buffered
                      wx.glcanvas.WX_GL_DEPTH_SIZE, 16,      # 16 bit depth
                      wx.glcanvas.WX_GL_STENCIL_SIZE, 8, 0)  # 8 bit stencil
        ...
        self._rightWindow = wx.adv.SashLayoutWindow(self)
        ...
        self._rightWindow.SetOrientation( wx.adv.LAYOUT_VERTICAL )
        self._rightWindow.SetAlignment( wx.adv.LAYOUT_RIGHT )
        if not fixedGlWindow:
            self._rightWindow.SetSashVisible( wx.adv.SASH_LEFT, True )
        self._rightWindow.Bind( wx.adv.EVT_SASH_DRAGGED, self.onSashDragRightWindow )
        ...
        self._bottomWindow = wx.adv.SashLayoutWindow(self)
        ...
        self._bottomWindow.SetOrientation( wx.adv.LAYOUT_HORIZONTAL )
        self._bottomWindow.SetAlignment( wx.adv.LAYOUT_BOTTOM )
        if not fixedGlWindow:
            self._bottomWindow.SetSashVisible( wx.adv.SASH_TOP, True )
        self._bottomWindow.Bind( wx.adv.EVT_SASH_DRAGGED, self.onSashDragBottomWindow )
    ...
    def _layoutFrame(self):
        ...
        wx.adv.LayoutAlgorithm().LayoutFrame(self, self._glCanvas)
