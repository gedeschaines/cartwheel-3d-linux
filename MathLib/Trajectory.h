...
template<class T>
inline const char* getTrajectoryClassName(const T&) {
    const char* name = "GenericTrajectory<T>";
	return (char *)name;
}

template<>
inline const char* getTrajectoryClassName(const double&) {
    const char* name = "GenericTrajectory1d";
	return (char *)name;
}

template<>
inline const char* getTrajectoryClassName(const Vector3d&) {
    const char* name = "GenericTrajectory3d";
	return (char *)name;
}
