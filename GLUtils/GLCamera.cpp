...
void GLCamera::applyCameraTransformations(){
	...
	// Build the orientation. We will construct it by rotating about the z axis, y axis first,
	// and then the x.
	...
	// We know we are looking down the z-axis of the camera coordinate frame. So we need to compute
	// what that axis is in world coordinates.
	...
	// Now we have all the information we need: the camera coordinate frame expressed in world
	// coordinates. Need only invert it...
